...
describe '[STEP2] ユーザログイン後のテスト' do
  ...
  describe '投稿一覧画面のテスト' do
    ...
    context '投稿成功のテスト' do
      ...
      it 'リダイレクト先が、保存できた投稿の詳細画面になっている' do
        ...
        expect(page).to have_current_path '/books/' +( Book.last.id.to_s), ignore_query: true
      end
    end
  end
  ...
  describe '自分の投稿詳細画面のテスト' do
    ...
    context '表示内容の確認' do
      it 'URLが正しい' do
        expect(page).to have_current_path '/books/' +( book.id.to_s), ignore_query: true
      end
    ...
    context '編集リンクのテスト' do
      it '編集画面に遷移する' do
        click_link 'Edit'
        expect(page).to have_current_path '/books/' + book.id.to_s +( '/edit'), ignore_query: true
      end
    end
  ...
  describe '自分のユーザ詳細画面のテスト' do
    ...
    context '表示の確認' do
      it 'URLが正しい' do
        expect(page).to have_current_path '/users/' +( user.id.to_s), ignore_query: true
      end
  ...
  describe '自分のユーザ情報編集画面のテスト' do
    ...
    context '表示の確認' do
      it 'URLが正しい' do
        expect(page).to have_current_path '/users/' + user.id.to_s +( '/edit'), ignore_query: true
      end
