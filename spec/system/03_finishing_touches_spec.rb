...
describe "[STEP3] 仕上げのテスト" do
  ...
  describe "他人の画面のテスト" do
    ...
    describe "他人の投稿詳細画面のテスト" do
      ...
      context "表示内容の確認" do
        it "URLが正しい" do
          expect(page).to have_current_path "/books/" + other_book.id.to_s, ignore_query: true
        end
    ...
    describe "他人のユーザ詳細画面のテスト" do
      ...
      context "表示の確認" do
        it "URLが正しい" do
          expect(page).to have_current_path "/users/" + other_user.id.to_s, ignore_query: true
        end
